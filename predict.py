...
def predict(test_data, init_model, tag_to_id):
    print("")
    print("")
    print("")
    print("Prediction -> untranslatables: original text")
    print("")
...
def main(sentence_to_predict):
    ...
    #model_testing_sentences = ['Steve UN to Paris', 'Steve why to Paris', 'Elixir and from other']
    try:
        isinstance(sentence_to_predict, str)
    except:
        raise ValueError('must be a string...')
    else:
        model_testing_sentences = [sentence_to_predict]
